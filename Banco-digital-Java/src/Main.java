public class Main {
    ...
    public static void main(String[] args) {
        ...
        Cliente Dum = new Cliente("Dum", bancoInicial);  
        Dum.setNome("Carla Edila Silveira"); //insere o nome do cliente

        Conta ccorrente = new ContaCorrente(Dum); //instanciada nova conta corrente
